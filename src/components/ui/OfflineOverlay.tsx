...
/**
 * Componente que muestra una pantalla de error a pantalla completa
 * cuando no hay conexión a internet.
 * Se integra globalmente para evitar depender de navegaciones que fallarían sin red.
 */
export function OfflineOverlay() {
  ...
  // Evitar renderizado accidental en servidor
    ...
    <AnimatePresence>
      {!isOnline && (
        <motion.div
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="fixed inset-0 z-[9999] bg-[#050510] flex flex-col items-center justify-center p-4 overflow-hidden"
        >
          {/* Luz de Error Dinámica */}
          <motion.div
            animate={{
